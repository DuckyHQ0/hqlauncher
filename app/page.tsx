...
export default function Home() {
    return (
        <div className="flex flex-col w-full h-full overflow-y-auto gap-36">
            ...
            <div className="section-style w-full h-full flex flex-col gap-64 min-hfull overflow-y-auto p-64">
