...
export default function AccountItem({
  ...
  return (
    <form className="flex p-6 justify-between items-center group">
      <div className="flex gap-20 items-center">
        ...
        <label className="body" id="displayname" htmlFor="radio">
          {displayname}
        </label>
      </div>
      <label className="body" id="username" htmlFor="radio">
        {active ? "Active" : "Not active"}
      </label>
      <label className="body" id="username" htmlFor="radio">
        {username}
      </label>
      <label className="body" id="uuid" htmlFor="radio">
        {uuid}
      </label>
    </form>
  );
