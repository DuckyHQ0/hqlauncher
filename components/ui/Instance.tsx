...
export default function Instance({ id, imageUrl, name }: InstanceProps) {
    ...
    return (
        <div className="bg-cover bg-no-repeat bg-clip-padding
            relative border border-stroke-1 text-white hover:scale-[.98] group duration-150 rounded-in w-[512px] h-[256px] flex flex-col place-content-between"
            style={{backgroundImage: `linear-gradient(to bottom,rgba(0,0,0,0),rgba(0,0,0,0.65)),url('${imageUrl}')`}}>
