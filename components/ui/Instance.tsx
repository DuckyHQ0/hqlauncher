	...
	return (
		...
		>
			<div className="fg-3 backdrop-blur-main h-fit w-full rounded-t-[7.55px] flex gap-48 px-32 py-16 opacity-0 group-hover:opacity-100 duration-150">
				<button><HiPlay className="w-[25px] h-[25px] hover-active-effect hover:text-selected" /></button>
				<button><HiPencil className="w-[25px] h-[25px] hover-active-effect hover:text-selected" /></button>
				<button><HiCog6Tooth className="w-[25px] h-[25px] hover-active-effect hover:text-selected" /></button>
			</div>
