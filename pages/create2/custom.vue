<template>
    <div>
        <div class="bg-[url(/hql-bg.png)] p-[128px] gap-[128px] grid grid-cols-2 bg-cover w-screen h-screen text-white grid-fill overflow-hidden">
            ...
            <div class="flex gap-[64px] max-[1375px]:gap-[32px]">
                <div
                ...
                >
                    <div class="flex flex-col gap-[24px] h-[75%]">
                    ...
                    <div class="bg-[#0f0f0f]/60 border-2 border-white/10 w-full h-full flex flex-col gap-[32px] overflow-y-auto backdrop-blur-xl rounded-[10px] p-[64px]">
                        ...
                        <div class="flex place-content-between align-middle place-items-center">
                            ...
                            <div class="flex flex-col gap-[16px]">
                                ...
                                <form class="flex gap-[16px]">
                                    <input type="checkbox" class="form-checkbox rounded-[5px] border-2 border-white/10 bg-[#0f0f0f]/40 text-brand-blue-1" />
                                    <p class="text-[13px]">Snapshots</p>
                                </form>
                            </div>
                        </div>
                        <div class="flex place-content-between align-middle place-items-center">
