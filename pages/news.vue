					...
					<TabGroup>
						...
						>
							...
							>
								<button
									:class="[
										'w-full bg-[#0f0f0f]/60 border-2 border-white/10 rounded-[10px] py-[16px] text-[20px]',
										selected ? 'text-brand-blue-1' : 'border-white/5',
									]"
								>
									{{ category }}
								</button>
						...
						<TabPanels class="h-full">
							<TabPanel
								...
								:key="idx"
								:class="['rounded-[10px] w-full h-full mb-[64px]']"
							>
								<ul
									class="h-full grid grid-cols-3 grid-rows-auto max-[1450px]:grid-cols-2 gap-[32px]"
								>
									<a
										v-for="post in posts"
										:key="post.id"
									...
									>
										...
										<h3 class="text-[28px] font-medium text-white/75">
											{{ post.date }}
										</h3>
									</a>
								</ul>
